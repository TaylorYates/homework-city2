...
- Create an array with the following values: "NYC", "SF", "LA", "ATX", "SYD"; use the array to add values to the ```<select>``` menu by using an ```.each``` loop in JavaScript (don't update the HTML to do this!)
